...
public class SwapTest {
    ...
    void rebaseTest(int x, int y) {
        assertTrue(y == Swap.rebase(x, y)[0]
                && x == Swap.rebase(x, y)[1]);
        kount++;
    ...
    void inEqualClassOne(int x, int y) {
        assertTrue(0 <= Swap.rebase(x, y)[0]
                && 0 <= Swap.rebase(x, y)[1]);
        rebaseTest(x, y);
    }

    void outOfEqualClassOne(int x, int y) {
        assertFalse(0 <= Swap.rebase(x, y)[0]
                && 0 <= Swap.rebase(x, y)[1]);
        rebaseTest(x, y);
    }
    ...
    void inEqualClassFive(int x, int y) {
        assertEquals(Math.abs(Swap.rebase(x, y)[0]), Math.abs(Swap.rebase(x, y)[1]));
        rebaseTest(x, y);
    }

    void outOfEqualClassFive(int x, int y) {
        assertNotEquals(Math.abs(Swap.rebase(x, y)[0]), Math.abs(Swap.rebase(x, y)[1]));
        rebaseTest(x, y);
    }
